...
import com.jonascaetanosz.github.embedmovies.tmdb.filmes.models.VideoSource;
...
public class BaixarFilme {
    ...
    public static void baixarFilme(String tmdbID, String path) {
        ...
        for (Player player : players) {
            ...
            // pegar VideoSource do player Warezcnd
            ...
            if (player.getPlayerName().startsWith("Warezcnd")) {
                ...
                try {
                    ...
                    videoSource = gson.fromJson(jsonResponse, VideoSource.class);
            ...
            if (videoSource != null){
                System.out.println(videoSource.getVideoSource());
            }
    }
}
